...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Portal de Influêncers Avance Modas" },
      { name: "description", content: "Portal de envio de etiquetas, fotos e videos das influencers da Avance Modas." },
      { property: "og:title", content: "Portal de Influêncers Avance Modas" },
      { name: "twitter:title", content: "Portal de Influêncers Avance Modas" },
      { property: "og:description", content: "Portal de envio de etiquetas, fotos e videos das influencers da Avance Modas." },
      { name: "twitter:description", content: "Portal de envio de etiquetas, fotos e videos das influencers da Avance Modas." },
